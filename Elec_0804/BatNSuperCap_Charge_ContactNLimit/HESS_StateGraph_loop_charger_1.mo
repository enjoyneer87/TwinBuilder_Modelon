...
equation
    ...
    connect(averageStepUpDownDCDC.controlBus,SCap.controlBus) annotation(Line(points = {{-114,4},{-114,20.35},{-159.29,20.35},{-159.29,2.1}},color = {240,170,40},pattern = LinePattern.Dot));
    ...
    connect(averageStepUpDownDCDC.plug_b,SCap.plug_a) annotation(Line(points = {{-132,-6},{-132,-7.9},{-157.29,-7.9}},color = {255,128,0}));
