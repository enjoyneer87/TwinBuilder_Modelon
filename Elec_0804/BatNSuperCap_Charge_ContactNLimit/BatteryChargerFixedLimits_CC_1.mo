...
model BatteryChargerFixedLimits_CC_1 "Battery charger with fixed limits"
  parameter Modelica.Units.SI.Voltage vMax=450 "Maximum voltage" annotation (Dialog(group="Charger limits"));
  parameter Modelica.Units.SI.Current iMax=1000 "Maximum current" annotation (Dialog(group="Charger limits"));
  parameter Modelica.Units.SI.Power pMax=35e12 "Maximum power" annotation (Dialog(group="Charger limits"));
...
end BatteryChargerFixedLimits_CC_1;
