...
model CrateHysteresis_StateGraph_2
  ...
  .Electrification.Electrical.DCSensor dCSensor
    ...
    .BatNSuperCap_Charge_ContactNLimit.BatteryChargerFixedLimits_CC_1 batteryChargerFixedLimits_CC_(pMax = 350000000,vMax = 1000,enable_control_bus = false,iMax = 300) annotation(Placement(transformation(extent = {{-44.0,-72.0},{-24.0,-52.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .BatNSuperCap_Charge_ContactNLimit.AverageStepUpDownDCDC CapDCDC(controller(external_limits = true,listen = true,id_listen = battery2.id,typeListen = .Electrification.Utilities.Types.ControllerType.Battery,external_v_b = false,v_b_ref = 400)) annotation(Placement(transformation(extent = {{100.0,24.0},{120.0,44.0}},origin = {0.0,0.0},rotation = 0.0)));
