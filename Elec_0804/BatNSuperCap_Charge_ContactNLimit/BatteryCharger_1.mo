...
model BatteryCharger_1
  ...
  extends .Electrification.Loads.Templates.Base(
    ...
    redeclare replaceable .Electrification.Loads.Thermal.Lumped thermal,redeclare replaceable .BatNSuperCap_Charge_ContactNLimit.CntrlBatteryCharger controller,
