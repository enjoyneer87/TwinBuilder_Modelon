...
model BatFromCar_Symetry_ContactNLimit "A battery pack for an electric car"
  extends .Electrification.Batteries.Templates.BatteryPackLumped(
    ns=100,
    np=60,
    redeclare .Electrification.Batteries.Core.Examples.NCA.Characteristic core,redeclare replaceable .Electrification.Batteries.Electrical.Pack.SymmetricIdeal electrical,
...
end BatFromCar_Symetry_ContactNLimit;
