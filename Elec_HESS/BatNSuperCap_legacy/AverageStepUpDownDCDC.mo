...
model AverageStepUpDownDCDC
  ...
  extends .Electrification.Converters.Templates.DCDC(
    ...
    redeclare replaceable .Electrification.Converters.Control.MultiMode controller,fixed_temperature = true);
