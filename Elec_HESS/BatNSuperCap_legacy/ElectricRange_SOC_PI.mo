...
model ElectricRange_SOC_PI "Range of SCap electric vehicle for a specific drive cycle"
  ...
  .Electrification.Utilities.Blocks.TorqueArbitration torqueArbitration(
    ...
    .BatNSuperCap_legacy.SCCap SCap(initialize_with_OCV = true,redeclare replaceable .Electrification.Batteries.Electrical.Pack.SymmetricIsolated electrical) annotation(Placement(transformation(extent = {{-146.0,-10.0},{-166.0,10.0}},origin = {0.0,0.0},rotation = 0.0)));
equation
