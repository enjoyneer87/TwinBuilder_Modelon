...
model CrateHysteresis_StateGraphNonConverter
  ...
  .BatNSuperCap_legacy.BatFromCar_ContactNLimit battery(
    ...
    SOC_start = 0.2,redeclare replaceable .BatNSuperCap_legacy.BatLimitsAndContactors controller(redeclare replaceable .Electrification.Batteries.Control.LimitsFixed limits(iMaxOut = battery.i_nom_1C * 0.499,iMaxIn = battery.i_nom_1C * 0.499,external_enable = false),contactors(contactors_closed = false)),
