...
model CrateHysteresis_StateGraph
  ...
  import BatNSuperCap_legacy.BatFromCar_ContactNLimit;
  import BatNSuperCap_legacy.BatFromCar_SuperCapContactNLimit;
  ...
  Electrification.Electrical.DCSensor dCSensor
    ...
    .BatNSuperCap_legacy.BatteryChargerFixedLimits_CC_1 batteryChargerFixedLimits_CC_(pMax = 350000000,vMax = battery.controller.limits.vMax,enable_control_bus = false,iMax = 300) annotation(Placement(transformation(extent = {{-44.0,-72.0},{-24.0,-52.0}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
  ...
  connect(dCSensor.y[2],gain.u)
    ...
    connect(battery2.plug_a,dCSensor2.plug_b) annotation(Line(points = {{134,36.33},{95,36.33},{95,26},{88,26}},color = {255,128,0}));
    ...
    connect(getComponentLimits.componentBus,battery2.controlBus) annotation(Line(points = {{146,70},{136,70},{136,46.33}},color = {240,170,40},pattern = LinePattern.Dot));
    ...
    connect(close_contactors2.systemBus,battery2.controlBus) annotation(Line(points = {{110,42},{136,42},{136,46.33}},color = {240,170,40},pattern = LinePattern.Dot));
    ...
    connect(vInitB2.plug_a,battery2.plug_a) annotation(Line(points = {{120,20},{127,20},{127,36.33},{134,36.33}},color = {255,128,0}));
