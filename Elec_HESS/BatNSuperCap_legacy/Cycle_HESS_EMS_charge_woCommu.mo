...
model Cycle_HESS_EMS_charge_woCommu "Range of SCap electric vehicle for a specific drive cycle"
...
equation
    ...
    connect(batty.controlBus,soc.systemBus) annotation(Line(points = {{-124.13,-86.21},{-124.13,60.85},{-321.57,60.85}},color = {240,170,40},pattern = LinePattern.Dot));
    ...
    connect(dCSensor2.plug_a,batty.plug_a) annotation(Line(points = {{-61.36,-51.68},{-87.78,-51.68},{-87.78,-102.21},{-120.93,-102.21}},color = {255,128,0}));
    connect(batteryChargerFixedLimits_CC_.plug_a,dCSensor2.plug_b) annotation(Line(points = {{6.04,-99.33},{-17.66,-99.33},{-17.66,-51.68},{-41.36,-51.68}},color = {255,128,0}));
    connect(averageStepUpDownDCDC.plug_b,batteryChargerFixedLimits_CC_.plug_a) annotation(Line(points = {{-89.24,1.16},{-10.95,1.16},{-10.95,-99.33},{6.04,-99.33}},color = {255,128,0}));
...
end Cycle_HESS_EMS_charge_woCommu;
